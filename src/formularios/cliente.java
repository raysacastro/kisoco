...
cargar();
    ...
    void actualizar() {
        try {
            ...
            PreparedStatement psU = cn.prepareStatement("UPDATE cliente SET nomcli='"+nombre.getText()+"',numero='"+numero.getText()+"',cedula='"+cedula.getText()+"',credito='"+credito.getText()+"',direccion='"+direccion.getText()+"',sexo='"+sexoseleccionado+"' where idcli='"+id_cliente.getText()+"'");
            psU.executeUpdate();
...
//            JOptionPane.showMessageDialog(null,ex);
    ...
    void cargar_datos() throws SQLException {
        ...
        String sql = "SELECT nomcli,numero,cedula,sexo,direccion,credito FROM cliente where idcli='" + id_cliente.getText() + "'";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                registros[6] = rs.getString("credito");
            }
    ...
    void cargar() {
        ...
        String[] registros = new String[10];
        String sql = "SELECT idcli,nomcli,cedula,numero,sexo,direccion,credito FROM cliente";
    ...
    void cargar_filtro(String valor) {
        ...
        String[] registros = new String[10];
        String sql = "SELECT idcli,nomcli,numero,cedula,sexo,direccion,credito FROM cliente where CONCAT(nomcli,'',cedula)LIKE '%" + valor + "%'";
    ...
    void guardar_datos(){
        try {
            ...
            String sql = "";
            sql = "INSERT INTO cliente (nomcli,numero,cedula,direccion,credito,sexo)VALUES('" + nombre.getText() + "','" + numero.getText() + "','" + cedula.getText() + "','" + direccion.getText() + "','" + credito.getText() + "','" + sexoseleccionado + "')";
    ...
    private void initComponents() {
        ...
        jPanel1.add(id_cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, 250, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("NUMERO");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, -1, -1));
        jPanel1.add(numero, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 130, 250, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("SEXO");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, -1, -1));
        jPanel1.add(direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 160, 250, -1));
        ...
        t_cliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID CLIENTE", "NOMBRE", "CEDULA", "SEXO", "NUMERO", "DIRECCION", "CREDITO"
            }
        ) {
        ...
        if (t_cliente.getColumnModel().getColumnCount() > 0) {
            ...
            t_cliente.getColumnModel().getColumn(6).setMinWidth(80);
            t_cliente.getColumnModel().getColumn(6).setMaxWidth(80);
        }
        ...
        jPanel1.add(nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, 250, -1));
        ...
        jPanel1.add(cedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 100, 250, -1));

        sexo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SELECCIONE", "MASCULINO", "FEMENINO", "EMPRESA" }));
        jPanel1.add(sexo, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 220, 250, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("DIRECCION");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, -1, -1));
        jPanel1.add(credito, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, 250, -1));
...
this.dispose();
    ...
    private void t_clienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_t_clienteMouseClicked
     ...
     if(fila>=0){
      DefaultTableModel table_model = (DefaultTableModel) t_cliente.getModel();
       String sexoEmpleado = (String) table_model.getValueAt(t_cliente.getSelectedRow(), 3);
       sexo.setSelectedItem(sexoEmpleado);
       id_cliente.setText(t_cliente.getValueAt(fila, 0).toString());
       nombre.setText(t_cliente.getValueAt(fila, 1).toString());
       cedula.setText(t_cliente.getValueAt(fila, 2).toString());
       numero.setText(t_cliente.getValueAt(fila, 4).toString());
       direccion.setText(t_cliente.getValueAt(fila, 5).toString()); 
       credito.setText(t_cliente.getValueAt(fila, 6).toString()); 
     }  
